    ...
    App.socket.on('controller', function (data) {
        console.log('rec ' + JSON.stringify(data));
         if (isset(data,"result") ) {
             ...
             if( data.result )$('#time'+data.tablet).addClass('bg-success');
             else $('#time'+data.tablet).addClass('bg-danger');
...
/*
    ...
    update_score.onclick = function () { App.socket.emit('controller', { updateScore: true }); };
